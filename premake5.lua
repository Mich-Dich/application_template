...
if os.target() == "windows" then
    premake.tools.mkdir = "if not exist \"%s\" mkdir \"%s\""
end
    ...
    project "application_template"      -- generated by the setup.py script, modefiy "app_settings.yml" to change name
        ...
        filter "system:linux"
            ...
            postbuildcommands
            {
                ...
                '{MKDIR} "%{wks.location}/bin/' .. outputs .. '/%{prj.name}/config"',
                '{COPY} "%{wks.location}/scripts/app_settings.yml" "%{wks.location}/bin/' .. outputs .. '/%{prj.name}/config/app_settings.yml"',
            }
